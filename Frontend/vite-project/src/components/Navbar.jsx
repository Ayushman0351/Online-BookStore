...
export default function Navbar() {
  ...
  // using hooks to change the theme(dark/light mode)
  ...
  // using hooks to manage state(shadow effect on navbar)
  ...
  return (
    <>
    <div className={`max-w-screen-2x1 container mx-auto md:px-20 px-4 dark:bg-slate-900 dark: text-white fixed top-0 left-0 right-0 z-50 ${sticky?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 trasition-all ease-in-out":""}`}>
...
{/* theme change button */}
 ...
 <label className="swap swap-rotate">
  ...
  <div>
    <a className="bg-white text-black p-2 rounded-md hover:bg-grey duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()}>
    Login</a>
    <Login/>
